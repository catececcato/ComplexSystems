...
```{r, echo=TRUE}
plot(filename$Frontal_change1,type='l', xlab = "Time", ylab =" Change in EEG Engagement")
...
```{r, echo=TRUE}
plot(filename$Central_change1,type='l', xlab = "Time", ylab =" Change in EEG Engagement")
...
```{r, echo=TRUE}
plot(filename$Parietal_change1,type='l', xlab = "Time", ylab =" Change in EEG Engagement")
...
```{r, echo=TRUE}
plot(filename$Total_change1,type='l', xlab = "Time", ylab =" Change in EEG Engagement")
